...
#         students = Student.objects.all()
#         student_count = Student.objects.count()
#         student_data = serialize("python", students) #serialize convert from dict to json
#         print(student_data)
#         data = {
...
#         serializer = StudentSerializer(data=request.data) #data is inside of request.data
